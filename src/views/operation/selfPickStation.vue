  ...
  <div class="sys-body">
    <div class="sys-neiBody">
      ...
      <div class="rightbox">
          ...
          <el-col :span="24">
            <div style="height: calc(100vh - 185px)">
              <el-table stripe border :data="tableData" height="calc(100% - 40px)">
                ...
                <el-table-column :label="$t('operation.finishOrderQuantity')" width="150">
                  <template slot-scope="scope">
                    <el-button type="text" @click="showOrder(scope.row, 8)">{{scope.row.order_complete_count}}</el-button>
                  </template>
                </el-table-column>
                <el-table-column :label="$t('operation.orderStock')" width="150">
                  <template slot-scope="scope">
                    <el-button type="text" @click="showOrder(scope.row, 4)">{{scope.row.order_store_count}}</el-button>
                  </template>
                </el-table-column>
        ...
        <el-dialog :title="$t('operation.orderQuantity')" width="1400px" @close="orderDialog=false" :visible.sync="orderDialog" :close-on-click-modal="false" center >
          <div style="height: calc(100vh - 350px)">
            <el-row>
              <el-col :span="24">
                <el-form :inline="true" :model="searchOrder">
                  ...
                  <el-form-item>
                    <el-button type="primary" @click="searchOrderFunc" size="mini" icon="el-icon-search"></el-button>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
            <el-table stripe border :data="tableDataOrder" height="calc(100% - 70px)">
              ...
              <el-table-column :label="$t('order.servicer_id')" width="170">
                <template slot-scope="scope" >
                  ...
                  <div>
                    <el-button v-if="scope.row.servicer_status === 1" type="text" size="small">
            ...
            <el-row style="margin-top: 10px">
              <el-col :span="24" style="text-align: right;">
                <el-pagination v-if="itemCountOrder > 0"
