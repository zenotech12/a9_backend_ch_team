            ...
            <div class="page-form">
              ...
              >
                ...
                <el-form-item :label="$t('operation.shopName')">
                  <el-input disabled v-model="shopForm.name" />
                </el-form-item>

                <el-form-item :label="$t('operation.shopLogo')">
                  <image-upload
                    :drag="false"
                    @uploadSuccess="imageUploadSuccess"
                  >
                    <img
                      v-if="shopForm.avatar"
                      :src="getImageUrl(shopForm.avatar)"
                      class="shop-logo"
                    />
                ...
                <el-form-item v-if="permissionCheck('opt')">
                  <confirm-button
                    ...
                    :disabled="disabled"
                    :confirmButtonInfor="this.$t('tools.save')"
                  />
                </el-form-item>
              </el-form>
            </div>
...
export default {
  ...
  methods: {
    getShopInfo() {
      this.shopForm.published = this.shopInfo.published
        ? this.shopInfo.published
        : false;
