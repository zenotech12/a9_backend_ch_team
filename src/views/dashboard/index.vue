  ...
  <div class="dashboard-container">
    <el-row>
      <el-card shadow="always">
        <div class="star-info cp" @click="gotoUrl('/order/evaluate')">
          ...
          <div class="rate-item">
            <span>{{ $t("order.star") }}</span>

            <el-rate
              class="rate"
              :value="shopInfo.star_score"
              disabled
              show-score
              text-color="#ff9900"
      ...
      <el-col :span="24">
        <el-row>
          ...
          >
            <el-card shadow="always" class="stat-item">
              ...
              <div class="">
                <div
                  class="info_stats"
                  @click="gotoUrl('orderList', { daiStatus: 'Seller' })"
                >
                  <span class="info_title">{{ $t("order.sellerDrl") }}</span>

                  <span class="info_value">
                    {{ statInfo.order_need_claim }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('orderList', { daiStatus: 'Purchaser' })"
                >
                  <span class="info_title">{{ $t("order.purchaseDrl") }}</span>

                  <span class="info_value">
                    {{ statInfo.order_purchaser_claim }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('orderList', { daiStatus: 'Warehouse' })"
                >
                  <span class="info_title">
                    {{ $t("order.warehouseDrl") }}</span
                  >

                  <span class="info_value">
                    {{ statInfo.order_warehouser_claim }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('orderList', { daiStatus: 'Finance' })"
                >
                  <span class="info_title"> {{ $t("order.financeDrl") }}</span>

                  <span class="info_value">
                    {{ statInfo.order_financer_claim }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('orderList', { order_status: 5 })"
                >
                  <span class="info_title">
                    {{ $t("order.tobedelivered") }}
                  </span>
          ...
          <el-col
            ...
            :xl="6"
            v-if="
              permissionCheck('view', '3_2') || permissionCheck('view', '3_4')
            "
          >
            <el-card shadow="always" class="stat-item">
              <div slot="header" class="clearfix">
                <div class="info_header">
                  <i class="el-icon-sort" style="background-color: #f50057" />
              ...
              <div class="">
                <div class="info_stats" @click="gotoUrl('/order/orderReturn')">
                  <span class="info_title">
                ...
                <div
                  class="info_stats"
                  @click="gotoUrl('/order/orderExchange')"
                >
                  <span class="info_title">
                    {{ $t("order.Replacement") }}
                  </span>
                  ...
                  <span class="info_value">
                    {{ statInfo.exchange_need_approve }}
                  </span>
                </div>
                ...
                >
                  <span class="info_title">
                    {{ $t("order.Replacement2") }}
                  </span>

                  <span class="info_value">
                    {{ statInfo.exchange_need_ship }}
                  </span>
                </div>

                <div class="info_stats_placeholder">
                  <span class="info_title">
                    &nbsp;
                  </span>
          ...
          <el-col
            ...
            :lg="12"
            :xl="6"
            v-if="permissionCheck('view', '8_1')"
          >
            <el-card shadow="always" class="stat-item">
              <div slot="header" class="clearfix">
                <div class="info_header">
                  <i class="el-icon-truck" style="background-color: #00e676" />
              ...
              <div class="">
                ...
                <div
                  class="info_stats"
                  @click="gotoUrl('purchases', { status: 3 })"
                >
                  <span class="info_title">
                    {{ $t("order.Tobestored") }}
                  </span>
                  ...
                  <span class="info_value">
                    {{ statInfo.purchase_need_warehouse }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('inboundOutBound', { status: 2 })"
                >
                  <span class="info_title">
                    {{ $t("warehouse.chukuorderMsg") }}
                  </span>

                  <span class="info_value">
                    {{ statInfo.outbound_warehouser_confirm }}
                  </span>
                </div>
          ...
          >
            <el-card shadow="always">
              ...
              <div class="">
                <div
                  class="info_stats"
                  @click="gotoUrl('totalinventory', { zero_inventory: true })"
                >
                  <span class="info_title">
                    {{ $t("order.Tobepurchased") }}
                  </span>

                  <span class="info_value">
                    {{ statInfo.need_purchase }}
                  </span>
                </div>
                ...
                <div
                  class="info_stats"
                  @click="gotoUrl('purchases', { status: 1 })"
                >
                  <span class="info_title">
                  ...
                  <span class="info_value">
                    {{ statInfo.purchase_finance_approve }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('purchases', { status: 2 })"
                >
                  <span class="info_title">
                    {{ $t("order.Tobeleadership") }}
                  </span>

                  <span class="info_value">
                    {{ statInfo.purchase_leader_approve }}
                  </span>
                </div>

                <div
                  class="info_stats"
                  @click="gotoUrl('inboundOutBound', { status: 1 })"
                >
                  <span class="info_title">
                    {{ $t("warehouse.chukuorderMsg2") }}
                  </span>

                  <span class="info_value">
                    {{ statInfo.outbound_purchaser_approve }}
                  </span>
                </div>
              </div>
            </el-card>
    ...
    <el-row class="newStyleBox">
      ...
      <el-col :span="6" align="right">
        <el-button size="small" @click="exportCurrentData">
          {{ $t("warehouse.exportData3") }}
        </el-button>
      </el-col>
      ...
      <el-col :span="24">
        <el-row>
            ...
            <el-card style="margin-right: 20px">
              ...
              >
                <div class="inner_container">
                  <i
                    class="el-icon-money"
                    style="background-color: #d500f9 !important"
                  />
          ...
          <el-col :span="8">
            <el-card style="margin-right: 0px">
              <div
                class="stats_container"
                @click="
                  gotoUrl('orderList', {
              ...
              >
                <div class="inner_container">
                  <i
                    class="el-icon-box"
                    style="background-color: #2979ff !important"
                  />
                  ...
                  <div class="content_header">
                    ...
                    <div class="content_subtitle">
                      <span
                        ...
                        "
                      >
                        {{ $t("order.localGoodsPrice") }}
                        {{ dataInfo.local_goods_payprice | price }}
                      </span>
                      ...
                      <span
                        ...
                        "
                      >
                        {{ $t("order.overseaGoodsPrice") }}
                        {{ dataInfo.oversea_goods_payprice | price }}
                      </span>

                      <span>
                        {{ $t("order.postage") }}
                        {{ dataInfo.postage | price }}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <el-col :span="8">
            <el-card style="margin-right: 20px; margin-top: 20px">
              <div
                class="stats_container"
                @click="
                  gotoUrl('orderList', {
              ...
              >
                <div class="inner_container">
                  <i
                    class="el-icon-cpu"
                    style="background-color: #00b2cc !important"
                  />
                  ...
                  <div class="content_header">
                    ...
                    <div class="content_subtitle">
                      <span
                        ...
                        "
                      >
                        {{ $t("order.localGoodsCount") }}
                        {{ dataInfo.local_goods_count }}
                      </span>
                      ...
                      <span
                        ...
                        "
                      >
                        {{ $t("order.overseaGoodsCount") }}
                        {{ dataInfo.oversea_goods_count }}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <el-col :span="8">
            <el-card
              style="cursor: default; margin-right: 20px; margin-top: 20px"
            >
              <div class="stats_container" style="cursor: default !important;">
                <div class="inner_container">
                  <i
                    class="el-icon-user"
                    style="background-color: #00e676 !important"
                  />

                  <div class="content_header">
                    <div class="content_title">
                      {{ $t("order.visitorsNumber") }}
                    </div>
                  </div>
                </div>
            ...
            <el-card style="margin-top: 20px">
              <div class="stats_container" style="cursor: default !important;">
                <div class="inner_container">
                  <i
                    class="el-icon-view"
                    style="background-color: #ffc400 !important"
                  />
              ...
              <div class="stats_container" style="cursor: default !important;">
                <div class="inner_container">
                  <i
                    ...
                    style="background-color: #ff3d00 !important"
                  />

                  <div class="content_header">
                    <div class="content_title">
                      {{ $t("order.customerPrice") }}
                    </div>
                  </div>
                </div>

                <div class="content_value">
                  {{ dataInfo.per_order_money | price }}
                </div>
              </div>
            </el-card>
          </el-col>
    ...
    <el-row class="newStyleBox">
      ...
      <el-col :span="24">
        <el-row type="flex" justify="space-between" align="middle">
          ...
          <el-col :span="4" align="right" class="totalMember">
            <span class="heading">
              {{ $t("operation.Totalusers") }}
            </span>
      ...
      <el-col :span="24">
        <el-row>
          <div class="echart">
            <el-col class="xx">
              <IEcharts :option="optionNewUser" :notMerge="true" />
            </el-col>
          </div>
        </el-row>
      </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="listPaidStyle">
              ...
              <el-row type="flex" justify="space-between" align="middle">
                <el-col :span="8">
                  <el-form :model="searchSales">
                    <el-form-item>
                      <el-radio-group v-model="timeValueSales" size="medium">
                        <el-radio-button :label="1">
                          {{ $t("order.today") }}
                        </el-radio-button>
              ...
              <el-table border :data="listSales" height="400">
                ...
                <el-table-column :label="$t('order.goods')">
                  <template slot-scope="scope">
                    <div>
                      <a
                        :href="
                          `https://www.a9kh.com/goods/${scope.row.id}.html`
                        "
                        target="_blank"
                        class="styleImgShow"
                      >
                        <img
                          :src="imgUrl + scope.row.images[0]"
                          height="80"
                          alt=""
                        />
          ...
          <el-col :span="12">
            <div class="listPaidStyle">
              <div style="margin-bottom: 10px;">
                {{ $t("order.purchaseRank") }}
              </div>

              <el-row type="flex" justify="space-between" align="middle">
                <el-col :span="8">
                  <el-form :model="searchPurchase">
                    <el-form-item>
                      <el-radio-group v-model="timeValuePurchase" size="medium">
                        <el-radio-button :label="1">
                          {{ $t("order.today") }}
                        </el-radio-button>
              ...
              <el-table border :data="listPurchase" height="400">
                <el-table-column label="#" type="index" width="50" />
          ...
          <el-col :span="24">
            <el-collapse v-model="otherPaiHangBang">
              <el-collapse-item :title="$t('order.otherLeaderboard')" name="1">
                <el-col :span="12">
                  <div class="listPaidStyle">
                    <div class="paihangbangTitle">
                      {{ $t("order.addShopRanking") }}
                    </div>
  ...
  methods: {
    ...
    getDataInfo() {
      statisticsCountV2(this.searchForm).then(res => {
        ...
        this.dataInfo["allGoodsCount"] =
          this.dataInfo.local_goods_count + this.dataInfo.oversea_goods_count;
      });
    },
    getListData() {
    ...
    getStatInfo() {
      ...
      const items = [
        "order_need_claim",
        "order_purchaser_claim",
        "order_warehouser_claim",
        "order_financer_claim",
        "need_ship",
        "exchange_need_approve",
        "exchange_need_ship",
        "purchase_need_warehouse",
        "need_purchase",
        "purchase_finance_approve",
        "purchase_leader_approve",
        "refund",
        "outbound_purchaser_approve",
        "outbound_warehouser_confirm"
      ];
...
.info_stats {
  ...
  &:hover {
    ...
    box-shadow: 0px 1px 6px 0.5px rgba($color: #000000, $alpha: 0.2);
  }
}

.info_stats_placeholder {
  cursor: default;
  display: flex;
  justify-content: space-between;
  align-items: center;
