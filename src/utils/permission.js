export default [
  ...
  { 'name': '仓库管理', 'lk': 'warehouseMgr', 'code': '8', 'permissions': [], 'urls': [], 'son': [
    { 'name': '总库存', 'lk': 'totalinventory', 'code': '8_4', 'permissions': ['view', 'opt'], 'urls': [] },
  ...
  { 'name': '导出管理', 'lk': 'exportMgr', 'code': '11', 'permissions': [], 'urls': [], 'son': [
    { 'name': '报告导出', 'lk': 'reportExport', 'code': '11_1', 'permissions': ['view', 'opt'], 'urls': [] },
  ] }
]
