<template>
  <div>
    <el-input
      readonly
      :placeholder="$t('warehouse.TipsMsg2')"
      clearable
      v-model="orderInfo.no"
      @clear="clearInput"
    >
      <el-button
        slot="append"
        icon="el-icon-edit-outline"
        @click="showGoodsTable"
      ></el-button>
    </el-input>
    <el-dialog
      width="90%"
      ...
      append-to-body
    >
      <span slot="title" style="font-weight: bold; font-size: 15px">{{$t('operation.orderList')}}</span>
      ...
      <el-row>
        <el-col :span="24">
          ...
          >
              ...
              <template slot-scope="scope">
                ...
                >
                  <div style="padding: 15px; padding-top: 5px">
                    ...
                    >
                      ...
                      <el-timeline style="margin-top: 10px">
                        ...
                        >
                          <div class="ui">
                            <span style="font-weight: bold; color: black">{{ comments.operator_name }}</span>
                            <span style="word-break: normal; color: #606266">{{ comments.comment }}</span>
                          </div>
                        </el-timeline-item>
                      </el-timeline>
                    </template>
                  ...
                  <a slot="reference" class="gt"
                    >{{ $t("order.note") }}<i class="el-icon-arrow-right"></i
                  ></a>
                </el-popover>
              </template>
            </el-table-column>
              ...
              <template slot-scope="scope">
                <el-popover placement="left" width="300" trigger="click">
                  <el-timeline style="margin-top: 10px">
                    ...
                    >
                      <div class="ui">
                        <span style="font-weight: bold; color: black; padding-right: 10px">{{ record.operator_name }}</span
            ...
            <!-- 状态 -->
            <el-table-column :label="$t('order.status')" width="135" align="center">
              <template slot-scope="scope">
                ...
                >
                  ...
                  <div class="g-info">
                    <p style="display: flex; align-items: center">
                      <span style="word-break: normal; color: #606266">{{ gInfo.goods_info.spu_name }}</span>
                      <img
            ...
            <!-- 金额 -->
            <el-table-column :label="$t('order.price')" width="300">
              <template slot-scope="scope">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="success" size="small" @click="submitSelect">{{
          $t("tools.confirm")
        }}</el-button>
  ...
  data() {
    return {
      ...
      orderStatusTab: [
        ...
        { value: "17", label: this.$t("order.status1") },
        { value: "2", label: this.$t("order.status2") },
        { value: "5", label: this.$t("order.status5") },
        { value: "4", label: this.$t("order.status4") },
        { value: "8", label: this.$t("order.status8") },
        { value: "10", label: this.$t("order.status10") },
        { value: "7", label: this.$t("order.status7") },
      ],
      orderStatusTabList: [
        { value: "0", label: this.$t("tools.all") },
        { value: "17", label: this.$t("order.status1") },
